    ...
    var app = new Vue({
        ...
        methods: {
            ...
            loadData: function (criteria, currentPage, pageSize) {
                ...
                this.$http.get("get_dicts_json", criteria).then(function (res) {
            ...
            handleRefresh: function () {
                window.location.href = localStorage.getItem("adminPath") + "/manage/dict/index";
            },
            ...
            handleEdit: function (index, row) {
                ...
                this.dictForm.label = row.label;
                this.dictForm.value = row.value;
                this.dictForm.sort = row.sort;
