    ...
    var app = new Vue({
        ...
        methods: {
            ...
            loadData: function (criteria, currentPage, pageSize) {
                ...
                this.$http.get("get_brand_json", criteria).then(function (res) {
            ...
            handleAdd: function (index, row) {
                ...
                this.brandForm.name = '';
                this.brandForm.code = '';
                this.brandForm.isCoocaaSystem = 1;
            },
            ...
            handleEdit: function (index, row) {
                ...
                this.brandForm.isCoocaaSystem = row.isCoocaaSystem;
            },
