    ...
    var app = new Vue({
        ...
        methods: {
            ...
            loadData: function (criteria, currentPage, pageSize) {
                ...
                this.$http.get("get_screenSize_json", criteria).then(function (res) {
            ...
            handleAdd: function (index, row) {
                ...
                this.screenSizeForm.id = '';
                this.screenSizeForm.label = ''
            },

            // 新增
            addSubmit: function () {
                var _this = this;
                this.$refs.screenSizeForm.validate((valid) => {
                    if (valid) {
            ...
            handleEdit: function (index, row) {
                ...
                this.screenSizeForm.id = row.id;
                this.screenSizeForm.label = row.label
            },
...
function getFormParams(_this) {
    var q = "";
    var formData = _this.screenSizeForm;
