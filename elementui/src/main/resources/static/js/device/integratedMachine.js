    ...
    var app = new Vue({
        ...
        methods: {
            ...
            loadData: function (criteria, currentPage, pageSize) {
                ...
                this.$http.get("get_integratedMachine_json", criteria).then(function (res) {
            ...
            handleAdd: function (index, row) {
                ...
                this.integratedMachineForm.id = '';
                this.integratedMachineForm.label = '';
            },

            // 新增
            addSubmit: function () {
                var _this = this;
                this.$refs.integratedMachineForm.validate((valid) => {
                    if (valid) {
            ...
            handleEdit: function (index, row) {
                ...
                // console.log(row);
                this.integratedMachineForm.id = row.id;
                this.integratedMachineForm.label = row.label;
            },
...
function getFormParams(_this) {
    var q = "";
    var formData = _this.integratedMachineForm;
