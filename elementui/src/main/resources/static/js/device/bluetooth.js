    ...
    var app = new Vue({
        ...
        methods: {
            ...
            loadData: function (criteria, currentPage, pageSize) {
                ...
                this.$http.get("get_bluetooths_json", criteria).then(function (res) {
            ...
            handleAdd: function (index, row) {
                ...
                this.bluetoothForm.id = '';
                this.bluetoothForm.bluetoothModel = '';
                this.bluetoothForm.bluetoothVersion = '';
            },

            // 新增
            addSubmit: function () {
                var _this = this;
                this.$refs.bluetoothForm.validate((valid) => {
                    if (valid) {
            ...
            handleEdit: function (index, row) {
                ...
                // console.log(row);
                this.bluetoothForm.id = row.id;
                this.bluetoothForm.bluetoothModel = row.bluetoothModel;
                this.bluetoothForm.bluetoothVersion = row.bluetoothVersion;
            },
...
function getFormParams(_this) {
    var q = "";
    var formData = _this.bluetoothForm;
