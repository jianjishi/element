    ...
    var app = new Vue({
        ...
        methods: {
            ...
            loadData: function (criteria, currentPage, pageSize) {
                ...
                this.$http.get("get_remoteControls_json", criteria).then(function (res) {
            ...
            handleAdd: function (index, row) {
                ...
                this.remoteControlForm.id = '';
                this.remoteControlForm.remoteControlModel = '';
                this.remoteControlForm.isBluetoothRemoteControl = 0;
            },

            // 新增
            addSubmit: function () {
                var _this = this;
                this.$refs.remoteControlForm.validate((valid) => {
                    if (valid) {
            ...
            handleEdit: function (index, row) {
                ...
                // console.log(row);
                this.remoteControlForm.id = row.id;
                this.remoteControlForm.remoteControlModel = row.remoteControlModel;
                this.remoteControlForm.isBluetoothRemoteControl = row.isBluetoothRemoteControl;
            },
...
function getFormParams(_this) {
    var q = "";
    var formData = _this.remoteControlForm;
