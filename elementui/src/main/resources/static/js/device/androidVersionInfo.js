    ...
    var app = new Vue({
        ...
        methods: {
            ...
            loadData: function (criteria, currentPage, pageSize) {
                ...
                this.$http.get("get_androidVersionInfo_json", criteria).then(function (res) {
            ...
            handleAdd: function (index, row) {
                ...
                this.androidVersionForm.id = '';
                this.androidVersionForm.value = '';
            },

            // 新增
            addSubmit: function () {
                var _this = this;
                this.$refs.androidVersionForm.validate((valid) => {
                    if (valid) {
            ...
            handleEdit: function (index, row) {
                ...
                this.androidVersionForm.id = row.id;
                this.androidVersionForm.value = row.value;
            },
...
function getFormParams(_this) {
    var q = "";
    var formData = _this.androidVersionForm;
